-- Temporarily disable the foreign key constraint to insert demo users
-- This is needed because the auth.users table is managed by Supabase Auth
...
SELECT 'Successfully inserted users:' as result, count(*) as count FROM public.users;
